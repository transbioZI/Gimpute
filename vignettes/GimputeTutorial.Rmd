...
date: "Modified: 30 Jul 2018. Compiled: `r format(Sys.Date(), '%d %b %Y')`"
output: 
...
* [PLINK](https://www.cog-genomics.org/plink2) (1.90)
* [GCTA64](http://cnsgenomics.com/software/gcta/#Download) (1.91.5beta) 
...
In this subsection, three major functions `removedMonoSnp()`, `phaseImpute2()`
(alternatively, `phaseImpute4()` and `postImpQC()` are used for the purpose of 
...
The metadata information file, the final well imputed and a subset of imputed dataset (dataset-specific) are essential for the subsequent analysis.
