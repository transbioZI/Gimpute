...
* Chip annotation file for genotype information mapping and strand check.
* The file with the IDs of the excluded instances.
* The file with the IDs of the excluded probes of the chip.
