...
This annotation file is particularly important for strand checking and genomic information of genotypes on a variety of genome builds.
```{r} 
## since the annotation file is too big, we do not upload this file
## chipAnnoFile <- "/home/affyChip/GenomeWideSNP_6.na32.strand.txt"
chipAnnoFile <- NULL 
``` 
